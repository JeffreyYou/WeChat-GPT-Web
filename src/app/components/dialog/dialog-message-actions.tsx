    ...
    return <div className={styles['chat-input-actions']}>
        <Select
            ...
            options={[
                ...
                { value: GptVersion.GPT_4, label: 'gpt-4 [Unavailable]' },
                { value: GptVersion.GPT_4_32K, label: 'gpt-4-32k [Unavailable]' },
            ]}
            onChange={(value) => {
        ...
        />
        <ChatAction text="Clear Context" icon={<ClearOutlined />} onClick={() => {
            chatStore.updateCurrentSession((session) => {
